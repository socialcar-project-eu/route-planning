...
namespace SocialCar.RoutePlanner.Carpools
{
    ...
    public static class GooglePoints
    {
        ...
        /// <returns></returns>
        public static IEnumerable<Routing.Nodes.Point> Decode(string encodedPoints)
        {
            ...
            while (index < polylineChars.Length)
            {
                ...
                yield return new Routing.Nodes.Point(Latitude, Longitude)
                { 
        ...
        /// <returns></returns>
        public static string Encode(IEnumerable<Routing.Nodes.Point> points)
        {
